...
const NAV_SECTIONS: NavSection[] = [
	{
		...
		links: [
			...
			{ href: "/history", icon: ReceiptText, label: "Account Statement" },
		],
	},
	{
		id: "trading",
	...
	},
	{
		...
		icon: Wallet1,
		links: [
			{ href: "/deposit", icon: AddSquare, label: "Deposit Funds" },
			{ href: "/withdrawal", icon: MinusSquare, label: "Withdrawal" },
		],
	},
	{
		id: "profile",
		...
		icon: ProfileCircle,
		links: [
			{ href: "/profile", icon: Profile, label: "Profile Settings" },
			{ href: "/kyc", icon: ShieldSecurity, label: "Identity Verification" },
		],
	},
	{
		id: "referral",
...
const BOTTOM_NAVLINKS = [
	...
	{ href: "/market", icon: Candle, label: "Market" },
	{ href: "/deposit", icon: AddSquare, label: "Deposit" },
	{ href: "/history", icon: ReceiptText, label: "History" },
	{ href: "/profile", icon: Setting2, label: "Profile" },
];
