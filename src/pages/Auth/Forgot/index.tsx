...
const Index = () => {
	...
	return (
		<main className="z-5 relative drop-shadow-md mx-auto p-4 md:p-6 xl:p-8 rounded-2xl w-full max-w-xl">
			<div className="my-8 text-center">
				<h1 className="mb-2 font-bold text-xl md:text-2xl xl:text-3xl">
					Forgot Password
				</h1>
			...
			<div className="flex justify-between items-center font-semibold text-[11px] text-card-foreground md:text-xs xl:text-sm uppercase tracking-tight montserrat">
				...
				<Link className="hover:text-accent duration-300" to="/login">
					Login
				</Link>
			</div>
		</main>
